...
export default function RationalVol33(): JSX.Element {
    return (
        <>
            ...
            <iframe className="rational" src={`${DOCUMENT_ROOT}/pdfjs/web/viewer.html?file=${DOCUMENT_ROOT}/rational/vol33/vol33.pdf`} title="2019年発行 レーショナル 第33号" />
            <h2>楽曲</h2>
            <div className="extra-contents">
                <h3>OverThere  composer:機械システム工学科 4年 hysk</h3>
                <audio className="audio" controls>
                    <source src={`${DOCUMENT_ROOT}/rational/vol33/OverThere_hysk_PM4.mp3`} type="audio/mpeg" />
                </audio>
                <h3>手探り  composer:総合工学科II類 1年 yiu</h3>
                <audio className="audio" controls>
                    <source src={`${DOCUMENT_ROOT}/rational/vol33/手探り_yiu_2類.mp3`} type="audio/mpeg" />
                </audio>
            </div>
        </>
    );
