...
export default function Home(): JSX.Element {
    return (
        <>
            ...
            <h2>2022年度のレーショナル</h2>
            <p>
                <Link href="/vol36/">こちら</Link>のページで見ることができます。(メニューからも行けます)<br />
            ...
            <h2>タイムライン</h2>
            <Link className="twitter-timeline" data-lang="ja" data-width="400" data-height="600" href="https://twitter.com/sofken_natori?ref_src=twsrc%5Etfw">Tweets by sofken_natori</Link>
