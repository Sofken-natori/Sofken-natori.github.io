        ...
        <CPPEnt slug="literal">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <Entry literal="0b1011" literalType="int" name="2進数リテラル" note="C++14で追加" />
                    ...
                    <Entry literal="&apos;a&apos;" literalType="char" name="文字リテラル" note={<>C++20以降は<C>char8_t</C>型</>} />
                    <Entry literal="&quot;abcd&quot;" literalType="char *" name="文字列リテラル" note={<>C++20以降は<C>char8_t *</C>型</>} />
                    ...
                    <Entry literal="12345l" literalType="long" name="整数リテラル" note={<>2/8/16進数リテラルでも同様。lを2つにすれば<C>long long</C>型となる</>} />
                </tbody>
            </table>
        </CPPEnt>
    );
