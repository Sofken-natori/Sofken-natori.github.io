...
import { CPPEntLink, cppEntHardPages, cppEntPages, CppEntPages, CppEntPageSlugs, S } from '../components';
...
export default function CPPEntHome(): JSX.Element {
    return (
        <>
            ...
            <p>
                C++入門にようこそ！<br />
                このC++入門は以前から部内で継承されていた「C++講習会」を少し修正した上で一般公開した物...だった物です。<br />
                が、ほぼ一から書き直されたため原型がありません。<br />
            ...
            <div style={{ border: '3px solid hsl(0deg, 0%, 5%)', borderRadius: '0.5rem', padding: '0.5rem' }}>
                <S style={{ fontSize: '1.2', fontWeight: 'bold' }}>注意</S><br />
...
function CPPEntPageList({ pages }: { pages: CppEntPages }): JSX.Element {
    ...
    return (
        <ol style={{ listStyle: 'cjk-ideographic', margin: '0 0 0 1rem' }}>{items}</ol>
    );
}
